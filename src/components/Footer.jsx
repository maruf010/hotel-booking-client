...
const Footer = () => {
    return (
        <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
            <div className="lg:max-w-11/12 lg:mx-auto container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">RoomVarse
                        </span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-gray-900">Rooms</h3>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-start space-x-3">
                            ...
                            <a rel="noopener noreferrer" href="https://x.com/maruf010MD" target='_blank' title="Twitter" className="flex items-center p-1">
                            ...
                            <a rel="noopener noreferrer" href="https://www.instagram.com/itz.maruf.13/" target='_blank' title="Instagram" className="flex items-center p-1">
