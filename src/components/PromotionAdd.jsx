    ...
    return (
        <div className='font-web lg:max-w-10/12 lg:mx-auto mx-3 my-10 lg:my-16'>
            ...
            <div className='md:grid grid-cols-2 gap-5 md:gap-10 max-w-full overflow-hidden'>
                <div className='lg:p-16' data-aos="fade-down-right" data-aos-offset="100">
                    <img className='w-full lg:h-80' src={offer} alt="upcoming" />
                </div>
                <div className='relative mt-5 md:mt-0 flex justify-center items-center' data-aos="fade-down-left" data-aos-offset="100">
                    <div>
            ...
            <div className='hidden md:grid grid-cols-2 gap-5 md:gap-10 max-w-full overflow-hidden '>
                <div className='flex justify-center items-center' data-aos="fade-down-right" data-aos-offset="100">
                    <div>
                ...
                <div className='lg:p-16 mt-5 md:mt-0' data-aos="fade-down-left" data-aos-offset="100">
                    <img className='w-full lg:h-80' src={offer2} alt="upcoming" />
                </div>
            </div>
            <div className='md:hidden  gap-5 md:gap-10 max-w-full overflow-hidden '>
                <div className='lg:p-20 mt-5 md:mt-0' data-aos="fade-down-left" data-aos-offset="100">
                    <img className='w-full lg:h-80' src={offer2} alt="upcoming" />
                </div>
                <div className='flex justify-center items-center' data-aos="fade-down-right" data-aos-offset="100">
                    <div>
