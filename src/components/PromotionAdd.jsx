    ...
    return (
        <div className='font-web lg:max-w-10/12 lg:mx-auto mx-3 my-10 lg:my-16'>
            ...
            <div className='md:grid grid-cols-2 gap-5 md:gap-10 max-w-full overflow-hidden'>
                <div className='lg:p-16 lg:border-r-2 lg:border-b-2 rounded-2xl lg:border-orange-600' data-aos="fade-right" data-aos-offset="100">
                ...
                <div className='relative mt-5 md:mt-0 flex justify-center items-center ' data-aos="fade-left" data-aos-offset="100">
                    <div>
                        <h2 className='text-4xl font-bold text-blue-900'>VISIT HOTEL SILKCITY WEBSITE
                        </h2>
            ...
            <div className='hidden md:grid grid-cols-2 gap-5 md:gap-10 max-w-full overflow-hidden mt-10 lg:mt-0'>
                <div className='flex justify-center items-center' data-aos="fade-right" data-aos-offset="100">
                    <div>
                        <h2 className='text-4xl font-bold text-blue-900'>EASILY SUBSCRIBE TO HOTEL SILKCITY </h2>
                ...
                <div className='lg:p-16 mt-5 md:mt-0 rounded-2xl lg:border-l-2 lg:border-t-2 border-orange-600' data-aos="fade-left" data-aos-offset="100">
