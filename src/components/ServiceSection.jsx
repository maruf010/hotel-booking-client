            ...
            <div className="grid md:grid-cols-2 gap-10 items-center ">
                ...
                <div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        ...
                        <div data-aos="fade-down-left" data-aos-offset="100" className="p-5 border border-green-300 rounded-lg shadow hover:shadow-lg transition">
                        ...
                        <div data-aos="fade-down-right" data-aos-offset="100" className="p-5 border border-green-300 rounded-lg shadow hover:shadow-lg transition">
                        ...
                        <div data-aos="fade-down-left" data-aos-offset="100" className="p-5 border border-orange-300 rounded-lg shadow hover:shadow-lg transition">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                        <img
                            src='https://i.ibb.co/k2hYwPjJ/app-banner1-1738819351.jpg'
                            alt='coming'
                    ...
                    <div
                        className='overflow-hidden rounded-xl shadow-lg '
                        data-aos="fade-down-left" data-aos-offset="100"
                    >
                        <img
                            src='https://i.ibb.co/k6MSJYgJ/16531216117-0a64a0dfb3-z.jpg'
                            alt='coming'
                            className="w-full h-56 object-cover transform transition-transform duration-500 hover:scale-110"
                        />
                    </div>
                    ...
                    >
                        <img
                            src='https://i.ibb.co/Jj5dytBB/Web-oct-17th-enhanced.png'
                            alt='coming'
                            className="w-full h-56 object-cover transform transition-transform duration-500 hover:scale-110"
                        />
                    </div>
                    ...
                    >
                        <img
                            src='https://i.ibb.co/b5GjNvWH/social-153147770.jpg'
                            alt='coming'
                            className="w-full h-56 object-cover transform transition-transform duration-500 hover:scale-110"
                        />
                    </div>
