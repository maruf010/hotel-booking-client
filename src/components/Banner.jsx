...
const Banner = () => {
    ...
    return (
        <Swiper
            ...
            className="mySwiper min-h-screen font-web w-full overflow-hidden"
            breakpoints={{
                320: { slidesPerView: 1 },
                640: { slidesPerView: 1 },
        ...
        >
            {/* slide 1  */}
            <SwiperSlide>
                <section className=" bangla-font px-3 overflow-hidden">
                    <div className="flex  mx-auto ">
                        <div className="text-center relative z-10 text-white mt-56 mx-auto">
                            <div className='bg-white/30 backdrop-blur-sm py-10 rounded-2xl border-2'>
                                ...
                                <Link to='/allRooms'>
                                    <div className="mx-auto flex justify-center mt-3" data-aos="fade-up" data-aos-offset="100" >
